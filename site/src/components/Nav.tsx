      ...
      >
        ...
        {NAV_LINKS.map((link, i) => (
          <a
            ...
            style={{ gridColumn: `${8 + offset + i * 2} / span 2` }}
          >
            {link.label}
          </a>
        ))}
        ...
        <a
          ...
          className="hidden items-center justify-center gap-1.5 rounded-full bg-white/15 px-4 py-2 font-margem text-sm font-medium text-white transition-colors hover:bg-white/25 md:inline-flex"
          style={{ gridColumn: `${14 + offset} / span 1` }}
        >
          GitHub
