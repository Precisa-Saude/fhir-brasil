        ...
        <div className="col-span-full md:col-span-12 md:col-start-2">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2">
            {PILLARS.map((pillar) => (
              <div
                key={pillar.title}
                className="flex gap-4 rounded-xl border border-ps-violet-dark/8 bg-white/50 p-6 outline outline-1 outline-ps-violet-dark/5 backdrop-blur-sm transition-colors hover:border-ps-violet-dark/15"
              >
          ...
          <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-ps-violet-dark px-6 py-3 font-margem text-sm font-medium text-white shadow-md transition-all hover:shadow-lg"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1 rounded-full border border-ps-violet-dark/20 bg-transparent px-6 py-3 font-margem text-sm font-medium text-ps-violet-dark transition-colors hover:border-ps-violet-dark hover:bg-ps-violet-dark hover:text-white"
            >
              Contribuir →
            </a>
          </div>
