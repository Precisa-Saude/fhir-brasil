    ...
    <section id="open-source" className="min-h-[50svh] bg-white/30 py-20 sm:py-28">
      <div className="mx-auto grid gap-4 px-4 md:px-0" style={gridStyle}>
        ...
        {PILLARS.map((pillar, i) => {
          ...
          return (
            <div
              ...
              style={{
                gridColumn: `${col.start + offset} / span ${col.span}`,
              }}
            >
        ...
        <a
          ...
          className="col-span-full inline-flex items-center justify-center gap-2 rounded-full bg-ps-violet-dark px-6 py-3 font-margem text-sm font-medium text-white transition-all md:col-span-2"
          style={{ gridColumnStart: 6 + offset }}
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="col-span-full inline-flex items-center justify-center gap-1 rounded-full border border-ps-violet-dark/20 bg-transparent px-6 py-3 font-margem text-sm font-medium text-ps-violet-dark transition-colors hover:border-ps-violet-dark hover:bg-ps-violet-dark hover:text-white md:col-span-2"
          style={{ gridColumnStart: 8 + offset }}
        >
          Contribuir →
        </a>
      </div>
